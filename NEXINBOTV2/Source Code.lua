...
if LocalPLR.Name ~= Username then
    ...
    chat("NEXINBOTV2 Running!")
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Thank You",
        Text = "Thank you for using NEXINBOT!",
        Time = 6
    })
    ...
    function commands(player, message)
        ...
        if msg:sub(1, 9) == Prefix .. "3drender" then
            ...
            function runCode()
                if switch == "disable" then
                    ...
                    showDefaultGui(true, "NEXINBOTV2 Running (3drender disabled)")
        ...
        if msg:sub(1, 12) == Prefix .. "privacymode" then
            ...
            function runCode()
                ...
                elseif switch == "enable" then
                    showDefaultGui(true, "NEXINBOTV2 Running (privacy mode enabled)")
